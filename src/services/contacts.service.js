// define a set of functions for accessing the database
...
async function updateContact(id, payload) {
    ...
    if (String(updatedContact.avatar).startsWith('/public/uploads/')) {
        unlink(`../../uploads/${updatedContact.avatar}`, (err) => {})
    }
    //console.log(String(updatedContact.avatar).startsWith('/public/uploads') ? 'yes' : 'no')
...
async function deleteContact(id) {
    ...
    if (deletedContact.avatar && String(deletedContact.avatar).startsWith('/public/uploads')) {
...
async function deleteAllContacts() {
    ...
    contacts.forEach((contact) => {
        if (contact.avatar && String(contact.avatar).startsWith('/public/uploads')) {
